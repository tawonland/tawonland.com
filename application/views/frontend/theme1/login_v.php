...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url();?>"><b>Front</b>LTE</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <?php echo form_open('login/ceklogin', array('class' => 'form-horizontal')); ?>
      <div class="form-group has-feedback">
        <?php echo form_input(['name' => 'username'], '', ['id' => 'inputEmail3', 'class' => 'form-control', 'placeholder' => 'Email']); ?>

        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <?php echo form_password(['name' => 'password'],'',['class' => 'form-control', 'id' => 'inputPassword3', 'placeholder' => 'Password']); ?>
